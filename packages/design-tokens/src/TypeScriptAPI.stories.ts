...
export const ReactIntegration: Story = {
  render: () => ({
    template: `
      <div class="typescript-demo">
        <h2>React Integration</h2>
        <p>Use design tokens in React components with hooks.</p>

        <h3>Inline Styles</h3>
        <div class="code-block">
          <pre><code>import { colors, spacing, typography } from '@haspen-ui/design-tokens';
...
export default Button;</code></pre>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Integration patterns for React with hooks and CSS-in-JS.',
      },
    },
  },
};
